...
- Best fixed alpha on ID: alpha = 2.00, scale gain = 1.2292, shape consistency = 0.6442, drift = 5.7743.
- Same fixed alpha on OOD: scale gain = 1.2469, shape consistency = 0.6860, drift = 5.5703.
- Best auto setting on ID: tau_img = 7.00, scale gain = 0.9276, shape consistency = 1.0000, alpha_nonzero_rate = 0.7612.
- Same auto setting on OOD: scale gain = 0.9616, shape consistency = 1.0000, alpha_nonzero_rate = 0.7698.
