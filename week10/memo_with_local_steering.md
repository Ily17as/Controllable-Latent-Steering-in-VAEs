...
| split    | target   |      acc |    n |
|:---------|:---------|---------:|-----:|
| id_test  | shape    | 0.742917 | 4800 |
| ood_test | shape    | 0.690625 | 4800 |
| id_test  | scale    | 0.49125  | 4800 |
| ood_test | scale    | 0.528125 | 4800 |

## Main observations
- Shape probe accuracy: ID = 0.7429, OOD = 0.6906.
- Scale probe accuracy: ID = 0.4913, OOD = 0.5281.
- Best fixed alpha on ID: alpha = 2.00, scale gain = 1.8867, shape consistency = 0.6396, drift = 14.6587.
- Same fixed alpha on OOD: scale gain = 1.9269, shape consistency = 0.6640, drift = 14.4460.
- Best auto setting on ID: tau_img = 7.00, scale gain = 0.5064, shape consistency = 1.0000, alpha_nonzero_rate = 0.5121.
- Same auto setting on OOD: scale gain = 0.4982, shape consistency = 1.0000, alpha_nonzero_rate = 0.5102.
